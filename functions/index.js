...
app.post("/post", dbAuth, postOnePost);
app.get("/post/:postId", getPost);
app.delete("/post/:postId", dbAuth, deletePost);
app.get("/post/:postId/like", dbAuth, likePost);
app.get("/post/:postId/unlike", dbAuth, unlikePost);
app.post("/post/:postId/comment", dbAuth, commentOnPost);
